...
Defines the on-device touchscreen UI: rendering the current layer's six button
slots, handling touch input, navigating between layers, and reflecting BLE HID
connection state.
