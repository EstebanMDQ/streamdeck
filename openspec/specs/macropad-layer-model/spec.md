...
Defines the data model for layers and button actions shared as a normative
contract between firmware and webapp: six-slot layers, the three action
types (`key`, `media`, `layer`), and the root layer.
