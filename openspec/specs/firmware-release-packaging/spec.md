...
Defines how the macro pad firmware is built and released so it can be installed
onto an ESP32-2432S028R ("CYD") board through bmorcelli Launcher, without any
manual/local-only build steps.
